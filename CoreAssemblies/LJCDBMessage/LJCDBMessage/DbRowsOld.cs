...
namespace LJCDBMessage
{
	...
	//[XmlRoot("DbRows")]
	public class DbRows : IEnumerable<DbValues>
	{
		...
		{
			DbRows retValue = null;

			if (false == NetString.HasValue(fileSpec))
			{
				fileSpec = LJCDefaultFileName;
			}
			retValue = NetCommon.XmlDeserialize(typeof(DbRows), fileSpec, RootName)
				as DbRows;
			return retValue;
		}
		#endregion
		...
		public DbRows Clone()
		{
			var retValue = MemberwiseClone() as DbRows;
			return retValue;
		}
