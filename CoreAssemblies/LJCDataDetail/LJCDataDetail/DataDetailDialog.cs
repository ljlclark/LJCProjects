...
namespace LJCDataDetail
{
  ...
  public partial class DataDetailDialog : Form
  {
    ...
    public DataDetailDialog(string userID, string tableName)
    {
      ...
      ControlDetail = mDataDetailData.ControlDetail();
      LJCDataColumns = mDataDetailData.DataColumns(ControlDetail.ID);

      // Code to process ControlDetail and create controls.
