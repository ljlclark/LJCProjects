...
set sourcePath=%mainPath%\LJCProjectsDev"
...
set multiFilter="*.sln|*.csproj|*.cs|*.Designer.cs|*.resx|*.config|*.cmd|*.txt|*.sql|Doc\*.xml"
set skipFiles="BuildAll.cmd|ClearBuild.cmd|UpdateAll.cmd|ChangeFile.txt|PagesChangeFile.txt|BackupLog.txt|Build.txt|MissingFolders.txt"
