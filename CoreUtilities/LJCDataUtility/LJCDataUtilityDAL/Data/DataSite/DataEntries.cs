...
namespace LJCDataUtilityDAL
{
  ...
  public class DataEntries : List<DataEntry>
  {
      ...
      , long moduleID, long tableID)
    {
      ...
      if (tableID <= 0)
      {
        message += "tableID must be greater than zero.\r\n";
      }
      mArgError.Add(message);
      NetString.ThrowArgError(message);

      retValue = LJCSearchUnique(dataSiteID, entryTime, moduleID, tableID);
      if (null == retValue)
      {
    ...
    public DataEntries GetCollection(List<DataEntry> list)
    {
    ...
    public void LJCRemove(long dataSiteID, DateTime entryTime, long moduleID
      , long tableID)
    {
    ...
    public DataEntry LJCSearchPrimary(long id)
    {
    ...
    public DataEntry LJCSearchUnique(long dataSiteID, DateTime entryTime
      , long moduleID, long tableID)
    {
      DataEntry retValue = null;

      var comparer = new DataEntryUniqueComparer();
    ...
    public void LJCSortUnique(DataEntryUniqueComparer comparer)
    {
      if (Count != mPrevCount
