...
namespace LJCSQLUtilLibDAL
{
  ...
  public class ForeignKeyManager : ObjectManager<ForeignKey, ForeignKeys>
  {
    ...
    public DbJoins GetLoadJoins()
    {
      ...
      dataColumns.Add("TargetTable");
      dataColumns.LJCMapNames("TargetTable", "table_name"
        , "TargetTable");

      dataColumns.Add("TargetColumn");
      dataColumns.LJCMapNames("TargetColumn", "column_name"
        , "TargetColumn");

      dataColumns.Add("OrdinalPosition");
      dataColumns.LJCMapNames("OrdinalPosition", "ordinal_position"
        , "OrdinalPosition");
      dbJoin.Columns = dataColumns;
