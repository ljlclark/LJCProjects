...
{
  /// <summary>The DocMethodGroupHeading table Data Object.</summary>
  public class DocMethodGroupHeading : IComparable<DocMethodGroupHeading>
  {
    #region Constructors
    ...
    public DocMethodGroupHeading Clone()
    {
      var retValue = MemberwiseClone() as DocMethodGroupHeading;
      return retValue;
    }

    // Provides the default Sort functionality.
    /// <include path='items/CompareTo/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int CompareTo(DocMethodGroupHeading other)
    {
      int retValue;
    ...
    public static string TableName = "DocMethodGroupHeading";
  ...
  /// <summary>Sort and search on Heading value.</summary>
  public class DocMethodGroupHeadingUniqueComparer : IComparer<DocMethodGroupHeading>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(DocMethodGroupHeading x, DocMethodGroupHeading y)
    {
      int retValue;
