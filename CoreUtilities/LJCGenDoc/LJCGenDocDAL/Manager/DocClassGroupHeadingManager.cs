...
namespace LJCGenDocDAL
{
  ...
  public class DocClassGroupHeadingManager
  {
    ...
    public DocClassGroupHeadings Load(LJCDataColumns keyColumns = null
    ...
    public DocClassGroupHeading Retrieve(LJCDataColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
    ...
    public void Update(DocClassGroupHeading dataObject, LJCDataColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
