...
namespace LJCGenDocDAL
{
  ...
  public class DocMethodGroupHeadingManager
  {
    ...
    public DocMethodGroupHeadings Load(LJCDataColumns keyColumns = null
    ...
    public DocMethodGroupHeading Retrieve(LJCDataColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
    ...
    public void Update(DocMethodGroupHeading dataObject, LJCDataColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
