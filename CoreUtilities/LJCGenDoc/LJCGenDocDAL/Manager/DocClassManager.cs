...
namespace LJCGenDocDAL
{
  ...
  public class DocClassManager
  {
    ...
    public DocClasses Load(LJCDataColumns keyColumns = null
    ...
    public DocClass Retrieve(LJCDataColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
    ...
    public void Update(DocClass dataObject, LJCDataColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
