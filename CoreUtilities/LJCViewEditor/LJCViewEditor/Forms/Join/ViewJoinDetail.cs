...
namespace LJCViewEditor
{
  ...
  internal partial class ViewJoinDetail : Form
  {
    ...
    {
      JoinTableCombo.KeyPress += ComboNoSpaceKeyPress;
      JoinTableCombo.TextChanged += ComboNoSpaceChanged;
    }
    #endregion
    ...
    private void ComboNoSpaceKeyPress(object sender, KeyPressEventArgs e)
    {
      e.Handled = FormCommon.HandleSpace(e.KeyChar);
    }

    // Strips blanks from the text value.
    private void ComboNoSpaceChanged(object sender, EventArgs e)
    {
