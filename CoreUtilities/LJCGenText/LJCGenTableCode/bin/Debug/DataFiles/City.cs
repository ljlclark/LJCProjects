...
{
  /// <summary>The City table Data Object.</summary>
  public class City : IComparable<City>
  {
    ...
    public City Clone()
    {
      var retValue = MemberwiseClone() as City;
      return retValue;
    }
    ...
    //[Column("CityFlag", TypeName="_DBType_")]
    ...
    //[Column("ZipCode", TypeName="_DBType_(4")]
    ...
    //[Column("District", TypeName="_DBType_")]
    ...
    /// <summary>The CityFlag column name.</summary>
    public static string ColumnCityFlag = "CityFlag";

    /// <summary>The ZipCode column name.</summary>
    public static string ColumnZipCode = "ZipCode";

    /// <summary>The District column name.</summary>
  ...
  public class CityUniqueComparer : IComparer<City>
  {
