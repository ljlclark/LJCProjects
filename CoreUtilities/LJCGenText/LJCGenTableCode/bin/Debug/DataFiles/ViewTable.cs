...
{
  /// <summary>The ViewTable table Data Object.</summary>
  public class ViewTable : IComparable<ViewTable>
  {
    ...
    public ViewTable(ViewTable item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as ViewTable;
      return retValue;
    }
  ...
  public class ViewTableUniqueComparer : IComparer<ViewTable>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ViewTable x, ViewTable y)
    {
      int retValue;
