...
{
  /// <summary>The ViewJoin table Data Object.</summary>
  public class ViewJoin : IComparable<ViewJoin>
  {
    ...
    //[Column("JoinType", TypeName="_DBType_(60")]
    ...
    //[Column("TableAlias", TypeName="_DBType_(60")]
    ...
    /// <summary>The JoinType column name.</summary>
  ...
  public class ViewJoinUniqueComparer : IComparer<ViewJoin>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ViewJoin x, ViewJoin y)
    {
      int retValue;
