...
{
  /// <summary>The CodeTypeClass table Data Object.</summary>
  public class CodeTypeClass : IComparable<CodeTypeClass>
  {
    ...
    public CodeTypeClass(CodeTypeClass item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as CodeTypeClass;
      return retValue;
    }
  ...
  public class CodeTypeClassUniqueComparer : IComparer<CodeTypeClass>
  {
