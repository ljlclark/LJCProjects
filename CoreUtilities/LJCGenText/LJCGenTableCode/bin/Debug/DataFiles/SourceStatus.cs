...
{
  /// <summary>The SourceStatus table Data Object.</summary>
  public class SourceStatus : IComparable<SourceStatus>
  {
    ...
    public SourceStatus(SourceStatus item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    public SourceStatus Clone()
    {
      var retValue = MemberwiseClone() as SourceStatus;
      return retValue;
    }

    // Provides the default Sort functionality.
    /// <include path='items/CompareTo/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int CompareTo(SourceStatus other)
    {
      int retValue;
    ...
    public static string TableName = "SourceStatus";
  ...
  public class SourceStatusUniqueComparer : IComparer<SourceStatus>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(SourceStatus x, SourceStatus y)
    {
      int retValue;
