...
{
  /// <summary>The ViewGridColumn table Data Object.</summary>
  public class ViewGridColumn : IComparable<ViewGridColumn>
  {
    ...
    public ViewGridColumn(ViewGridColumn item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as ViewGridColumn;
      return retValue;
    }
    ...
    //[Column("ViewColumnID", TypeName="_DBType_")]
  ...
  public class ViewGridColumnUniqueComparer : IComparer<ViewGridColumn>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ViewGridColumn x, ViewGridColumn y)
    {
      int retValue;
