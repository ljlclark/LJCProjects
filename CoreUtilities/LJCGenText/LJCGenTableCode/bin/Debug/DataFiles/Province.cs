...
{
  /// <summary>The Province table Data Object.</summary>
  public class Province : IComparable<Province>
  {
    ...
    {
      var retValue = MemberwiseClone() as Province;
      return retValue;
    }
    ...
    //[Column("Abbreviation", TypeName="_DBType_(3")]
    ...
    /// <summary>The Abbreviation column name.</summary>
  ...
  public class ProvinceUniqueComparer : IComparer<Province>
  {
