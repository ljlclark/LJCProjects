...
{
  /// <summary>The Fixture table Data Object.</summary>
  public class Fixture : IComparable<Fixture>
  {
    ...
    {
      var retValue = MemberwiseClone() as Fixture;
      return retValue;
    }
  ...
  public class FixtureUniqueComparer : IComparer<Fixture>
  {
