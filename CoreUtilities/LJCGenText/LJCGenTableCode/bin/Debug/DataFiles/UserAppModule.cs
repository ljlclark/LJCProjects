...
{
  /// <summary>The UserAppModule table Data Object.</summary>
  public class UserAppModule : IComparable<UserAppModule>
  {
    #region Constructors
    ...
    public UserAppModule(UserAppModule item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as UserAppModule;
      return retValue;
    }

    // Provides the default Sort functionality.
    /// <include path='items/CompareTo/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int CompareTo(UserAppModule other)
    {
      int retValue;
    ...
    /// <summary>Gets or sets the AppModule_Id value.</summary>
    //[Column("AppModule_Id", TypeName="_DBType_")]
    public Int32 AppModule_Id
    {
      get { return mAppModule_Id; }
      set
      {
        mAppModule_Id = ChangedNames.Add(ColumnAppModule_Id, mAppModule_Id, value);
      }
    }
    private Int32 mAppModule_Id;
    ...
    /// <summary>The AppModule_Id column name.</summary>
    public static string ColumnAppModule_Id = "AppModule_Id";
  ...
  public class UserAppModuleUniqueComparer : IComparer<UserAppModule>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(UserAppModule x, UserAppModule y)
    {
      int retValue;
