...
{
  /// <summary>The DBMetaDataKey table Data Object.</summary>
  public class DBMetaDataKey : IComparable<DBMetaDataKey>
  {
    #region Constructors
    ...
    public DBMetaDataKey(DBMetaDataKey item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as DBMetaDataKey;
      return retValue;
    }

    // Provides the default Sort functionality.
    /// <include path='items/CompareTo/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int CompareTo(DBMetaDataKey other)
    {
      int retValue;
    ...
    //[Column("DBMetaDataColumnID", TypeName="_DBType_")]
    ...
    //[Column("DBMetaDataKeyTypeID", TypeName="_DBType_")]
    ...
    //[Column("ToTableID", TypeName="_DBType_")]
    ...
    //[Column("ToColumnID", TypeName="_DBType_")]
  ...
  public class DBMetaDataKeyUniqueComparer : IComparer<DBMetaDataKey>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(DBMetaDataKey x, DBMetaDataKey y)
    {
      int retValue;
