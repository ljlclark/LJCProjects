...
{
  /// <summary>The ViewFilter table Data Object.</summary>
  public class ViewFilter : IComparable<ViewFilter>
  {
    ...
    public ViewFilter(ViewFilter item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as ViewFilter;
      return retValue;
    }
  ...
  public class ViewFilterUniqueComparer : IComparer<ViewFilter>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ViewFilter x, ViewFilter y)
    {
      int retValue;
