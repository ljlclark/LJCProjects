...
{
  /// <summary>The ProcessGroup table Data Object.</summary>
  public class ProcessGroup : IComparable<ProcessGroup>
  {
    ...
    public ProcessGroup(ProcessGroup item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as ProcessGroup;
      return retValue;
    }
  ...
  public class ProcessGroupUniqueComparer : IComparer<ProcessGroup>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ProcessGroup x, ProcessGroup y)
    {
      int retValue;
