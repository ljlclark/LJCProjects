...
{
  /// <summary>The MapType table Data Object.</summary>
  public class MapType : IComparable<MapType>
  {
    #region Constructors
    ...
    {
      var retValue = MemberwiseClone() as MapType;
      return retValue;
    }
    ...
    public static string TableName = "MapType";
  ...
  public class MapTypeUniqueComparer : IComparer<MapType>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(MapType x, MapType y)
    {
      int retValue;
