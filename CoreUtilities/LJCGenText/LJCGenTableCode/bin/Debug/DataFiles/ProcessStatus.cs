...
{
  /// <summary>The ProcessStatus table Data Object.</summary>
  public class ProcessStatus : IComparable<ProcessStatus>
  {
    ...
    public ProcessStatus(ProcessStatus item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as ProcessStatus;
      return retValue;
    }
    ...
    //[Column("ProcessStatusID", TypeName="_DBType_")]
  ...
  public class ProcessStatusUniqueComparer : IComparer<ProcessStatus>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ProcessStatus x, ProcessStatus y)
    {
      int retValue;
