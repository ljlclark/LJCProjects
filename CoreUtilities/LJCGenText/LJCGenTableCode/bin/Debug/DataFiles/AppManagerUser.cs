...
{
  /// <summary>The AppManagerUser table Data Object.</summary>
  public class AppManagerUser : IComparable<AppManagerUser>
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DefaultConstructor/*' file='../../LJCDocLib/Common/Data.xml'/>
    public AppManagerUser()
    {
    ...
    public AppManagerUser(AppManagerUser item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    public AppManagerUser Clone()
    {
      var retValue = MemberwiseClone() as AppManagerUser;
      return retValue;
    }

    // Provides the default Sort functionality.
    /// <include path='items/CompareTo/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int CompareTo(AppManagerUser other)
    {
      int retValue;
  ...
  public class AppManagerUserUniqueComparer : IComparer<AppManagerUser>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(AppManagerUser x, AppManagerUser y)
    {
      int retValue;
