...
{
  /// <summary>The ViewData table Data Object.</summary>
  public class ViewData : IComparable<ViewData>
  {
    ...
    //[Column("ViewTableID", TypeName="_DBType_")]
    ...
    /// <summary>The ViewTableID column name.</summary>
  ...
  public class ViewDataUniqueComparer : IComparer<ViewData>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(ViewData x, ViewData y)
    {
      int retValue;
