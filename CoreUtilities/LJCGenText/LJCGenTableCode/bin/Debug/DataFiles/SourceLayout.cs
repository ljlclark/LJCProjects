...
{
  /// <summary>The SourceLayout table Data Object.</summary>
  public class SourceLayout : IComparable<SourceLayout>
  {
    ...
    public SourceLayout(SourceLayout item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as SourceLayout;
      return retValue;
    }
  ...
  public class SourceLayoutUniqueComparer : IComparer<SourceLayout>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(SourceLayout x, SourceLayout y)
    {
      int retValue;
