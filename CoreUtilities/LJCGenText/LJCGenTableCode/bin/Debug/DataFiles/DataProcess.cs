...
{
  /// <summary>The DataProcess table Data Object.</summary>
  public class DataProcess : IComparable<DataProcess>
  {
    ...
    public DataProcess(DataProcess item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as DataProcess;
      return retValue;
    }
  ...
  public class DataProcessUniqueComparer : IComparer<DataProcess>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(DataProcess x, DataProcess y)
    {
      int retValue;
