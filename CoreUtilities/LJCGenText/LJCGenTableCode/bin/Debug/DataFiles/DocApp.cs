...
{
  /// <summary>The DocApp table Data Object.</summary>
  public class DocApp : IComparable<DocApp>
  {
    #region Constructors
    ...
    public DocApp Clone()
    {
      var retValue = MemberwiseClone() as DocApp;
      return retValue;
    }

    // Provides the default Sort functionality.
    /// <include path='items/CompareTo/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int CompareTo(DocApp other)
    {
      int retValue;
    ...
    //[Column("RootPath", TypeName="_DBType_(100")]
    public String RootPath
    {
      ...
      {
        value = NetString.InitString(value);
        mRootPath = ChangedNames.Add(ColumnRootPath, mRootPath, value);
      }
    }
    ...
    public static string TableName = "DocApp";
    ...
    /// <summary>The RootPath column name.</summary>
    public static string ColumnRootPath = "RootPath";
    ...
    /// <summary>The RootPath maximum length.</summary>
    public static int LengthRootPath = 100;
    #endregion
  ...
  public class DocAppUniqueComparer : IComparer<DocApp>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(DocApp x, DocApp y)
    {
      int retValue;
