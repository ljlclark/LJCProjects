...
{
  /// <summary>The SourceType table Data Object.</summary>
  public class SourceType : IComparable<SourceType>
  {
    ...
    public SourceType(SourceType item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as SourceType;
      return retValue;
    }
  ...
  public class SourceTypeUniqueComparer : IComparer<SourceType>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(SourceType x, SourceType y)
    {
      int retValue;
