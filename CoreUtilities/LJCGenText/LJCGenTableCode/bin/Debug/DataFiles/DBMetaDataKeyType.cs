...
{
  /// <summary>The DBMetaDataKeyType table Data Object.</summary>
  public class DBMetaDataKeyType : IComparable<DBMetaDataKeyType>
  {
    ...
    public DBMetaDataKeyType(DBMetaDataKeyType item)
    {
      ChangedNames = new ChangedNames();
      ID = item.ID;
    }
    ...
    {
      var retValue = MemberwiseClone() as DBMetaDataKeyType;
      return retValue;
    }
    ...
    //[Column("Name", TypeName="_DBType_(15")]
    public String Name
    {
      get { return mName; }
      set
  ...
  public class DBMetaDataKeyTypeUniqueComparer : IComparer<DBMetaDataKeyType>
  {
    // Compares two objects.
    /// <include path='items/Compare/*' file='../../LJCDocLib/Common/Data.xml'/>
    public int Compare(DBMetaDataKeyType x, DBMetaDataKeyType y)
    {
      int retValue;
