...
namespace _NameSpace_
{
  ...
  internal _ClassName_GridCode(_AppName_List parentList)
  {
    ...
    _ParentName_Grid = _ParentName_List._ParentName_Grid;
    ResetData();
  ...
  internal void DataRetrieve()
  {
    ...
    {
      // Data from items.
      int _ParentName_ID = parentRow.LJCGetInt32(_ParentName_Data.ColumnID);

      var result = m_ClassName_Manager.ResultWithParentID(_ParentName_ID);
