...
{
  /// <summary>Provides TaskTransform SQL data methods.</summary>
  public class TaskTransformSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public TaskTransformSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(TaskTransform.ColumnID, TaskTransform.PropertyID);
      dataDefinition.MapNames(TaskTransform.ColumnID, TaskTransform.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        TaskTransform.ColumnID
      };
      ...
      ResultConverter = new ResultConverter<TaskTransform, TaskTransforms>();
    }
    #endregion
    ...
    public TaskTransform Add(TaskTransform dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateTaskTransform(dataTable);
      }
      return retValue;
    }
    ...
    public TaskTransforms Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TaskTransforms retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateTaskTransforms(dataTable);
      }
      return retValue;
    }
    ...
    public TaskTransform Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TaskTransform retValue = null;
    ...
    public void Update(TaskTransform dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { TaskTransform.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private TaskTransform CreateTaskTransform(DataTable dataTable)
    {
      TaskTransform retValue = null;
    ...
    private TaskTransforms CreateTaskTransforms(DataTable dataTable)
    {
      TaskTransforms retValue = null;
  ...
  public ResultConverter<TaskTransform, TaskTransforms> ResultConverter { get; set; }
