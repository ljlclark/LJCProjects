...
{
  /// <summary>Provides UnitCategory SQL data methods.</summary>
  public class UnitCategorySQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public UnitCategorySQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(UnitCategory.ColumnID, UnitCategory.PropertyID);
      dataDefinition.MapNames(UnitCategory.ColumnID, UnitCategory.PropertyID);
      ...
      ResultConverter = new ResultConverter<UnitCategory, UnitCategories>();
    }
    #endregion
    ...
    public UnitCategory Add(UnitCategory dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateUnitCategory(dataTable);
      }
      return retValue;
    }
    ...
    public UnitCategories Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateUnitCategories(dataTable);
      }
      return retValue;
    }
    ...
    public UnitCategory Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UnitCategory retValue = null;
    ...
    public void Update(UnitCategory dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { UnitCategory.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private UnitCategory CreateUnitCategory(DataTable dataTable)
    {
      UnitCategory retValue = null;
    ...
    private UnitCategories CreateUnitCategories(DataTable dataTable)
    {
      UnitCategories retValue = null;
  ...
  public ResultConverter<UnitCategory, UnitCategories> ResultConverter { get; set; }
