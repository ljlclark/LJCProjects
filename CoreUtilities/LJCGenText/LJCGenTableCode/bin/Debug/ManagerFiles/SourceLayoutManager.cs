...
{
  /// <summary>Provides SourceLayout SQL data methods.</summary>
  public class SourceLayoutSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public SourceLayoutSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(SourceLayout.ColumnID, SourceLayout.PropertyID);
      dataDefinition.MapNames(SourceLayout.ColumnID, SourceLayout.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        SourceLayout.ColumnID
      };
      ...
      ResultConverter = new ResultConverter<SourceLayout, SourceLayouts>();
    }
    #endregion
    ...
    public SourceLayout Add(SourceLayout dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateSourceLayout(dataTable);
      }
      return retValue;
    }
    ...
    public SourceLayouts Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      SourceLayouts retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateSourceLayouts(dataTable);
      }
      return retValue;
    }
    ...
    public SourceLayout Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      SourceLayout retValue = null;
    ...
    public void Update(SourceLayout dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private SourceLayout CreateSourceLayout(DataTable dataTable)
    {
      SourceLayout retValue = null;
    ...
    private SourceLayouts CreateSourceLayouts(DataTable dataTable)
    {
      SourceLayouts retValue = null;
  ...
  public ResultConverter<SourceLayout, SourceLayouts> ResultConverter { get; set; }
