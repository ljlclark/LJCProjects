...
{
  /// <summary>Provides DocAssembly SQL data methods.</summary>
  public class DocAssemblySQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocAssemblySQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocAssembly.ColumnID, DocAssembly.PropertyID);
      dataDefinition.MapNames(DocAssembly.ColumnID, DocAssembly.PropertyID);
    ...
    public DocAssembly Add(DocAssembly dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocAssembly(dataTable);
      }
      return retValue;
    }
    ...
    public DocAssemblies Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocAssemblies(dataTable);
      }
      return retValue;
    }
    ...
    private DocAssembly CreateDocAssembly(DataTable dataTable)
    {
      DocAssembly retValue = null;
    ...
    private DocAssemblies CreateDocAssemblies(DataTable dataTable)
    {
      DocAssemblies retValue = null;
