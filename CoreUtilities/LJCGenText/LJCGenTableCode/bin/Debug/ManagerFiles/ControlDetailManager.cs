...
{
  /// <summary>Provides ControlDetail SQL data methods.</summary>
  public class ControlDetailSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ControlDetailSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ControlDetail.ColumnID, ControlDetail.PropertyID);
      dataDefinition.MapNames(ControlDetail.ColumnID, ControlDetail.PropertyID);
    ...
    public ControlDetail Add(ControlDetail dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlDetail(dataTable);
      }
      return retValue;
    }
    ...
    public ControlDetails Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlDetails(dataTable);
      }
      return retValue;
    }
    ...
    public ControlDetail Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ControlDetail retValue = null;
    ...
    private ControlDetail CreateControlDetail(DataTable dataTable)
    {
      ControlDetail retValue = null;
    ...
    private ControlDetails CreateControlDetails(DataTable dataTable)
    {
      ControlDetails retValue = null;
