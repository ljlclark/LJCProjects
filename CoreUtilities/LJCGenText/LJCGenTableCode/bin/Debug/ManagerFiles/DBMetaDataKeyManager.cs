...
{
  /// <summary>Provides DBMetaDataKey SQL data methods.</summary>
  public class DBMetaDataKeySQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DBMetaDataKeySQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DBMetaDataKey.ColumnID, DBMetaDataKey.PropertyID);
      dataDefinition.MapNames(DBMetaDataKey.ColumnID, DBMetaDataKey.PropertyID);
      ...
      {
        DBMetaDataKey.ColumnName
      });

      ResultConverter = new ResultConverter<DBMetaDataKey, DBMetaDataKeys>();
    }
    #endregion
    ...
    public DBMetaDataKey Add(DBMetaDataKey dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDBMetaDataKey(dataTable);
      }
      return retValue;
    }
    ...
    public DBMetaDataKeys Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DBMetaDataKeys retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDBMetaDataKeys(dataTable);
      }
      return retValue;
    }
    ...
    public DBMetaDataKey Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DBMetaDataKey retValue = null;
    ...
    public void Update(DBMetaDataKey dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DBMetaDataKey.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DBMetaDataKey CreateDBMetaDataKey(DataTable dataTable)
    {
      DBMetaDataKey retValue = null;
    ...
    private DBMetaDataKeys CreateDBMetaDataKeys(DataTable dataTable)
    {
      DBMetaDataKeys retValue = null;
  ...
  public ResultConverter<DBMetaDataKey, DBMetaDataKeys> ResultConverter { get; set; }
