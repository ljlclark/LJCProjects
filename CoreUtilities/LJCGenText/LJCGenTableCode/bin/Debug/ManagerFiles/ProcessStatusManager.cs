...
{
  /// <summary>Provides ProcessStatus SQL data methods.</summary>
  public class ProcessStatusSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ProcessStatusSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ProcessStatus.ColumnID, ProcessStatus.PropertyID);
      dataDefinition.MapNames(ProcessStatus.ColumnID, ProcessStatus.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        ProcessStatus.ColumnID
      };
      ...
      ResultConverter = new ResultConverter<ProcessStatus, ProcessStatuses>();
    }
    #endregion
    ...
    public ProcessStatus Add(ProcessStatus dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateProcessStatus(dataTable);
      }
      return retValue;
    }
    ...
    public ProcessStatuses Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ProcessStatuses retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateProcessStatuses(dataTable);
      }
      return retValue;
    }
    ...
    public ProcessStatus Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ProcessStatus retValue = null;
    ...
    public void Update(ProcessStatus dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ProcessStatus.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ProcessStatus CreateProcessStatus(DataTable dataTable)
    {
      ProcessStatus retValue = null;
    ...
    private ProcessStatuses CreateProcessStatuses(DataTable dataTable)
    {
      ProcessStatuses retValue = null;
  ...
  public ResultConverter<ProcessStatus, ProcessStatuses> ResultConverter { get; set; }
