...
// DocAppFieldBehaviorSQLManager.cs
...
{
  /// <summary>Provides DocAppFieldBehavior SQL data methods.</summary>
  public class DocAppFieldBehaviorSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocAppFieldBehaviorSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocAppFieldBehavior.ColumnID, DocAppFieldBehavior.PropertyID);
      dataDefinition.MapNames(DocAppFieldBehavior.ColumnID, DocAppFieldBehavior.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        DocAppFieldBehavior.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        DocAppFieldBehavior.ColumnName
      });

      ResultConverter = new ResultConverter<DocAppFieldBehavior, DocAppFieldBehaviors>();
    }
    #endregion
    ...
    public DocAppFieldBehavior Add(DocAppFieldBehavior dataObject, List<string> propertyNames = null)
    {
      DocAppFieldBehavior retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateDocAppFieldBehavior(dataTable);
      }
      return retValue;
    }
    ...
    public DocAppFieldBehaviors Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocAppFieldBehaviors retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDocAppFieldBehaviors(dataTable);
      }
      return retValue;
    }
    ...
    public DocAppFieldBehavior Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocAppFieldBehavior retValue = null;
    ...
    public void Update(DocAppFieldBehavior dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetIDKey(long id)
    {
      ...
      {
        { DocAppFieldBehavior.ColumnID, id }
      };
      return retValue;
    }
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DocAppFieldBehavior.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DocAppFieldBehavior CreateDocAppFieldBehavior(DataTable dataTable)
    {
      DocAppFieldBehavior retValue = null;
    ...
    private DocAppFieldBehaviors CreateDocAppFieldBehaviors(DataTable dataTable)
    {
      DocAppFieldBehaviors retValue = null;
  ...
  public ResultConverter<DocAppFieldBehavior, DocAppFieldBehaviors> ResultConverter { get; set; }
