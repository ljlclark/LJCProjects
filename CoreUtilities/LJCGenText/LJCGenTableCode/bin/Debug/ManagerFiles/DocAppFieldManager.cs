...
{
  /// <summary>Provides DocAppField SQL data methods.</summary>
  public class DocAppFieldSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocAppFieldSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocAppField.ColumnID, DocAppField.PropertyID);
      dataDefinition.MapNames(DocAppField.ColumnID, DocAppField.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        DocAppField.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        DocAppField.ColumnName
      });

      ResultConverter = new ResultConverter<DocAppField, DocAppFields>();
    }
    #endregion
    ...
    public DocAppField Add(DocAppField dataObject, List<string> propertyNames = null)
    {
      DocAppField retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateDocAppField(dataTable);
      }
      return retValue;
    }
    ...
    public DocAppFields Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocAppFields retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDocAppFields(dataTable);
      }
      return retValue;
    }
    ...
    public DocAppField Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocAppField retValue = null;
    ...
    public void Update(DocAppField dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DocAppField.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DocAppField CreateDocAppField(DataTable dataTable)
    {
      DocAppField retValue = null;
    ...
    private DocAppFields CreateDocAppFields(DataTable dataTable)
    {
      DocAppFields retValue = null;
  ...
  public ResultConverter<DocAppField, DocAppFields> ResultConverter { get; set; }
