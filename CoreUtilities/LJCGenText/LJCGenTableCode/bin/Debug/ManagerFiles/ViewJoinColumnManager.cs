...
{
  /// <summary>Provides ViewJoinColumn SQL data methods.</summary>
  public class ViewJoinColumnSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewJoinColumnSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewJoinColumn.ColumnID, ViewJoinColumn.PropertyID);
      dataDefinition.MapNames(ViewJoinColumn.ColumnID, ViewJoinColumn.PropertyID);
      ...
      {
        ViewJoinColumn.ColumnName
      });

      ResultConverter = new ResultConverter<ViewJoinColumn, ViewJoinColumns>();
    }
    #endregion
    ...
    public ViewJoinColumn Add(ViewJoinColumn dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewJoinColumn(dataTable);
      }
      return retValue;
    }
    ...
    public ViewJoinColumns Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewJoinColumns(dataTable);
      }
      return retValue;
    }
    ...
    public ViewJoinColumn Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewJoinColumn retValue = null;
    ...
    public void Update(ViewJoinColumn dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ViewJoinColumn.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ViewJoinColumn CreateViewJoinColumn(DataTable dataTable)
    {
      ViewJoinColumn retValue = null;
    ...
    private ViewJoinColumns CreateViewJoinColumns(DataTable dataTable)
    {
      ViewJoinColumns retValue = null;
  ...
  public ResultConverter<ViewJoinColumn, ViewJoinColumns> ResultConverter { get; set; }
