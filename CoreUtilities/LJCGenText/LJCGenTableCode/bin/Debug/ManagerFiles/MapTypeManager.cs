...
{
  /// <summary>Provides MapType SQL data methods.</summary>
  public class MapTypeSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public MapTypeSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(MapType.ColumnID, MapType.PropertyID);
      dataDefinition.MapNames(MapType.ColumnID, MapType.PropertyID);
      ...
      ResultConverter = new ResultConverter<MapType, MapTypes>();
    }
    #endregion
    ...
    public MapType Add(MapType dataObject, List<string> propertyNames = null)
    {
      MapType retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateMapType(dataTable);
      }
      return retValue;
    }
    ...
    public MapTypes Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      MapTypes retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateMapTypes(dataTable);
      }
      return retValue;
    }
    ...
    public MapType Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      MapType retValue = null;
    ...
    public void Update(MapType dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { MapType.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private MapType CreateMapType(DataTable dataTable)
    {
      MapType retValue = null;
    ...
    private MapTypes CreateMapTypes(DataTable dataTable)
    {
      MapTypes retValue = null;
  ...
  public ResultConverter<MapType, MapTypes> ResultConverter { get; set; }
