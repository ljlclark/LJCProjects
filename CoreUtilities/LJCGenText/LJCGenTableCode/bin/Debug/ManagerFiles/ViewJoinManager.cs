...
{
  /// <summary>Provides ViewJoin SQL data methods.</summary>
  public class ViewJoinSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewJoinSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewJoin.ColumnID, ViewJoin.PropertyID);
      dataDefinition.MapNames(ViewJoin.ColumnID, ViewJoin.PropertyID);
      ...
      ResultConverter = new ResultConverter<ViewJoin, ViewJoins>();
    }
    #endregion
    ...
    public ViewJoin Add(ViewJoin dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewJoin(dataTable);
      }
      return retValue;
    }
    ...
    public ViewJoins Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewJoins(dataTable);
      }
      return retValue;
    }
    ...
    public ViewJoin Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewJoin retValue = null;
    ...
    public void Update(ViewJoin dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ViewJoin.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ViewJoin CreateViewJoin(DataTable dataTable)
    {
      ViewJoin retValue = null;
    ...
    private ViewJoins CreateViewJoins(DataTable dataTable)
    {
      ViewJoins retValue = null;
  ...
  public ResultConverter<ViewJoin, ViewJoins> ResultConverter { get; set; }
