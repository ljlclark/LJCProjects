...
{
  /// <summary>Provides DataProcess SQL data methods.</summary>
  public class DataProcessSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DataProcessSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DataProcess.ColumnID, DataProcess.PropertyID);
      dataDefinition.MapNames(DataProcess.ColumnID, DataProcess.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        DataProcess.ColumnID
      };
      ...
      ResultConverter = new ResultConverter<DataProcess, DataProcesses>();
    }
    #endregion
    ...
    public DataProcess Add(DataProcess dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDataProcess(dataTable);
      }
      return retValue;
    }
    ...
    public DataProcesses Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDataProcesses(dataTable);
      }
      return retValue;
    }
    ...
    public DataProcess Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DataProcess retValue = null;
    ...
    private DataProcess CreateDataProcess(DataTable dataTable)
    {
      DataProcess retValue = null;
    ...
    private DataProcesses CreateDataProcesses(DataTable dataTable)
    {
      DataProcesses retValue = null;
  ...
  public ResultConverter<DataProcess, DataProcesses> ResultConverter { get; set; }
