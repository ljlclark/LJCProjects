...
{
  /// <summary>Provides LayoutColumn SQL data methods.</summary>
  public class LayoutColumnSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public LayoutColumnSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(LayoutColumn.ColumnID, LayoutColumn.PropertyID);
      dataDefinition.MapNames(LayoutColumn.ColumnID, LayoutColumn.PropertyID);
      ...
      ResultConverter = new ResultConverter<LayoutColumn, LayoutColumns>();
    }
    #endregion
    ...
    public LayoutColumn Add(LayoutColumn dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateLayoutColumn(dataTable);
      }
      return retValue;
    }
    ...
    public LayoutColumns Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateLayoutColumns(dataTable);
      }
      return retValue;
    }
    ...
    public LayoutColumn Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      LayoutColumn retValue = null;
    ...
    public void Update(LayoutColumn dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private LayoutColumn CreateLayoutColumn(DataTable dataTable)
    {
      LayoutColumn retValue = null;
    ...
    private LayoutColumns CreateLayoutColumns(DataTable dataTable)
    {
      LayoutColumns retValue = null;
  ...
  public ResultConverter<LayoutColumn, LayoutColumns> ResultConverter { get; set; }
