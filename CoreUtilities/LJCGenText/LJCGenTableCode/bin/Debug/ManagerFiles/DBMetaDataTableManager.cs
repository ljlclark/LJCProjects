...
{
  /// <summary>Provides DBMetaDataTable SQL data methods.</summary>
  public class DBMetaDataTableSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DBMetaDataTableSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DBMetaDataTable.ColumnID, DBMetaDataTable.PropertyID);
      dataDefinition.MapNames(DBMetaDataTable.ColumnID, DBMetaDataTable.PropertyID);
      ...
      ResultConverter = new ResultConverter<DBMetaDataTable, DBMetaDataTables>();
    }
    #endregion
    ...
    public DBMetaDataTable Add(DBMetaDataTable dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDBMetaDataTable(dataTable);
      }
      return retValue;
    }
    ...
    public DBMetaDataTables Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DBMetaDataTables retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDBMetaDataTables(dataTable);
      }
      return retValue;
    }
    ...
    public DBMetaDataTable Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DBMetaDataTable retValue = null;
    ...
    public void Update(DBMetaDataTable dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DBMetaDataTable.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DBMetaDataTable CreateDBMetaDataTable(DataTable dataTable)
    {
      DBMetaDataTable retValue = null;
    ...
    private DBMetaDataTables CreateDBMetaDataTables(DataTable dataTable)
    {
      DBMetaDataTables retValue = null;
  ...
  public ResultConverter<DBMetaDataTable, DBMetaDataTables> ResultConverter { get; set; }
