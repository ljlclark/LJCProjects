...
{
  /// <summary>Provides ViewTable SQL data methods.</summary>
  public class ViewTableSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewTableSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewTable.ColumnID, ViewTable.PropertyID);
      dataDefinition.MapNames(ViewTable.ColumnID, ViewTable.PropertyID);
      ...
      ResultConverter = new ResultConverter<ViewTable, ViewTables>();
    }
    #endregion
    ...
    public ViewTable Add(ViewTable dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewTable(dataTable);
      }
      return retValue;
    }
    ...
    public ViewTables Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewTables retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateViewTables(dataTable);
      }
      return retValue;
    }
    ...
    public ViewTable Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewTable retValue = null;
    ...
    public void Update(ViewTable dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ViewTable.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ViewTable CreateViewTable(DataTable dataTable)
    {
      ViewTable retValue = null;
    ...
    private ViewTables CreateViewTables(DataTable dataTable)
    {
      ViewTables retValue = null;
  ...
  public ResultConverter<ViewTable, ViewTables> ResultConverter { get; set; }
