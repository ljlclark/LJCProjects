...
// DocMethodGroupHeadingSQLManager.cs
...
{
  /// <summary>Provides DocMethodGroupHeading SQL data methods.</summary>
  public class DocMethodGroupHeadingSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocMethodGroupHeadingSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocMethodGroupHeading.ColumnID, DocMethodGroupHeading.PropertyID);
      dataDefinition.MapNames(DocMethodGroupHeading.ColumnID, DocMethodGroupHeading.PropertyID);
    ...
    public DocMethodGroupHeading Add(DocMethodGroupHeading dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocMethodGroupHeading(dataTable);
      }
      return retValue;
    }
    ...
    public DocMethodGroupHeadings Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocMethodGroupHeadings(dataTable);
      }
      return retValue;
    }
    ...
    private DocMethodGroupHeading CreateDocMethodGroupHeading(DataTable dataTable)
    {
      DocMethodGroupHeading retValue = null;
    ...
    private DocMethodGroupHeadings CreateDocMethodGroupHeadings(DataTable dataTable)
    {
      DocMethodGroupHeadings retValue = null;
