...
{
  /// <summary>Provides StepTask SQL data methods.</summary>
  public class StepTaskSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public StepTaskSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(StepTask.ColumnID, StepTask.PropertyID);
      dataDefinition.MapNames(StepTask.ColumnID, StepTask.PropertyID);
      ...
      ResultConverter = new ResultConverter<StepTask, StepTasks>();
    }
    #endregion
    ...
    public StepTask Add(StepTask dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateStepTask(dataTable);
      }
      return retValue;
    }
    ...
    public StepTasks Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      StepTasks retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateStepTasks(dataTable);
      }
      return retValue;
    }
    ...
    public StepTask Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      StepTask retValue = null;
    ...
    public void Update(StepTask dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { StepTask.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private StepTask CreateStepTask(DataTable dataTable)
    {
      StepTask retValue = null;
    ...
    private StepTasks CreateStepTasks(DataTable dataTable)
    {
      StepTasks retValue = null;
  ...
  public ResultConverter<StepTask, StepTasks> ResultConverter { get; set; }
