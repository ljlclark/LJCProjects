...
{
  /// <summary>Provides ViewData SQL data methods.</summary>
  public class ViewDataSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewDataSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewData.ColumnID, ViewData.PropertyID);
      dataDefinition.MapNames(ViewData.ColumnID, ViewData.PropertyID);
      ...
      ResultConverter = new ResultConverter<ViewData, ViewDatas>();
    }
    #endregion
    ...
    public ViewData Add(ViewData dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewData(dataTable);
      }
      return retValue;
    }
    ...
    public ViewDatas Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewDatas retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateViewDatas(dataTable);
      }
      return retValue;
    }
    ...
    public ViewData Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewData retValue = null;
    ...
    public void Update(ViewData dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private ViewData CreateViewData(DataTable dataTable)
    {
      ViewData retValue = null;
    ...
    private ViewDatas CreateViewDatas(DataTable dataTable)
    {
      ViewDatas retValue = null;
  ...
  public ResultConverter<ViewData, ViewDatas> ResultConverter { get; set; }
