...
{
  /// <summary>Provides DocAppFile SQL data methods.</summary>
  public class DocAppFileSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocAppFileSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocAppFile.ColumnID, DocAppFile.PropertyID);
      dataDefinition.MapNames(DocAppFile.ColumnID, DocAppFile.PropertyID);
      ...
      {
        DocAppFile.ColumnName
      });

      ResultConverter = new ResultConverter<DocAppFile, DocAppFiles>();
    }
    #endregion
    ...
    public DocAppFile Add(DocAppFile dataObject, List<string> propertyNames = null)
    {
      DocAppFile retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateDocAppFile(dataTable);
      }
      return retValue;
    }
    ...
    public DocAppFiles Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocAppFiles retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDocAppFiles(dataTable);
      }
      return retValue;
    }
    ...
    public DocAppFile Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocAppFile retValue = null;
    ...
    public void Update(DocAppFile dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DocAppFile.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DocAppFile CreateDocAppFile(DataTable dataTable)
    {
      DocAppFile retValue = null;
    ...
    private DocAppFiles CreateDocAppFiles(DataTable dataTable)
    {
      DocAppFiles retValue = null;
  ...
  public ResultConverter<DocAppFile, DocAppFiles> ResultConverter { get; set; }
