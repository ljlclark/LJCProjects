...
// DocClassGroupHeadingSQLManager.cs
...
{
  /// <summary>Provides DocClassGroupHeading SQL data methods.</summary>
  public class DocClassGroupHeadingSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocClassGroupHeadingSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocClassGroupHeading.ColumnID, DocClassGroupHeading.PropertyID);
      dataDefinition.MapNames(DocClassGroupHeading.ColumnID, DocClassGroupHeading.PropertyID);
    ...
    public DocClassGroupHeading Add(DocClassGroupHeading dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocClassGroupHeading(dataTable);
      }
      return retValue;
    }
    ...
    public DocClassGroupHeadings Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocClassGroupHeadings(dataTable);
      }
      return retValue;
    }
    ...
    private DocClassGroupHeading CreateDocClassGroupHeading(DataTable dataTable)
    {
      DocClassGroupHeading retValue = null;
    ...
    private DocClassGroupHeadings CreateDocClassGroupHeadings(DataTable dataTable)
    {
      DocClassGroupHeadings retValue = null;
