...
{
  /// <summary>Provides UnitConversion SQL data methods.</summary>
  public class UnitConversionSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public UnitConversionSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(UnitConversion.ColumnID, UnitConversion.PropertyID);
      dataDefinition.MapNames(UnitConversion.ColumnID, UnitConversion.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        UnitConversion.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        UnitConversion.ColumnName
      });

      ResultConverter = new ResultConverter<UnitConversion, UnitConversions>();
    }
    #endregion
    ...
    public UnitConversion Add(UnitConversion dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateUnitConversion(dataTable);
      }
      return retValue;
    }
    ...
    public UnitConversions Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateUnitConversions(dataTable);
      }
      return retValue;
    }
    ...
    public UnitConversion Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UnitConversion retValue = null;
    ...
    public void Update(UnitConversion dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { UnitConversion.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private UnitConversion CreateUnitConversion(DataTable dataTable)
    {
      UnitConversion retValue = null;
    ...
    private UnitConversions CreateUnitConversions(DataTable dataTable)
    {
      UnitConversions retValue = null;
  ...
  public ResultConverter<UnitConversion, UnitConversions> ResultConverter { get; set; }
