...
{
  /// <summary>Provides TransformMatch SQL data methods.</summary>
  public class TransformMatchSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public TransformMatchSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(TransformMatch.ColumnID, TransformMatch.PropertyID);
      dataDefinition.MapNames(TransformMatch.ColumnID, TransformMatch.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        TransformMatch.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        TransformMatch.ColumnName
      });

      ResultConverter = new ResultConverter<TransformMatch, TransformMatchs>();
    }
    #endregion
    ...
    public TransformMatch Add(TransformMatch dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateTransformMatch(dataTable);
      }
      return retValue;
    }
    ...
    public TransformMatchs Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TransformMatchs retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateTransformMatchs(dataTable);
      }
      return retValue;
    }
    ...
    public TransformMatch Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TransformMatch retValue = null;
    ...
    public void Update(TransformMatch dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { TransformMatch.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private TransformMatch CreateTransformMatch(DataTable dataTable)
    {
      TransformMatch retValue = null;
    ...
    private TransformMatchs CreateTransformMatchs(DataTable dataTable)
    {
      TransformMatchs retValue = null;
  ...
  public ResultConverter<TransformMatch, TransformMatchs> ResultConverter { get; set; }
