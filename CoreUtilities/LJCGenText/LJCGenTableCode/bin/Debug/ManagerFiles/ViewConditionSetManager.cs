...
{
  /// <summary>Provides ViewConditionSet SQL data methods.</summary>
  public class ViewConditionSetSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewConditionSetSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewConditionSet.ColumnID, ViewConditionSet.PropertyID);
      dataDefinition.MapNames(ViewConditionSet.ColumnID, ViewConditionSet.PropertyID);
      ...
      {
        ViewConditionSet.ColumnName
      });

      ResultConverter = new ResultConverter<ViewConditionSet, ViewConditionSets>();
    }
    #endregion
    ...
    public ViewConditionSet Add(ViewConditionSet dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewConditionSet(dataTable);
      }
      return retValue;
    }
    ...
    public ViewConditionSets Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewConditionSets retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateViewConditionSets(dataTable);
      }
      return retValue;
    }
    ...
    public ViewConditionSet Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewConditionSet retValue = null;
    ...
    public void Update(ViewConditionSet dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ViewConditionSet.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ViewConditionSet CreateViewConditionSet(DataTable dataTable)
    {
      ViewConditionSet retValue = null;
    ...
    private ViewConditionSets CreateViewConditionSets(DataTable dataTable)
    {
      ViewConditionSets retValue = null;
  ...
  public ResultConverter<ViewConditionSet, ViewConditionSets> ResultConverter { get; set; }
