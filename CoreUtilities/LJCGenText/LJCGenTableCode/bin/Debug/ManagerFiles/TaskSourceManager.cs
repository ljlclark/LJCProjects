...
{
  /// <summary>Provides TaskSource SQL data methods.</summary>
  public class TaskSourceSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public TaskSourceSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(TaskSource.ColumnID, TaskSource.PropertyID);
      dataDefinition.MapNames(TaskSource.ColumnID, TaskSource.PropertyID);
      ...
      {
        TaskSource.ColumnName
      });

      ResultConverter = new ResultConverter<TaskSource, TaskSources>();
    }
    #endregion
    ...
    public TaskSource Add(TaskSource dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateTaskSource(dataTable);
      }
      return retValue;
    }
    ...
    public TaskSources Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TaskSources retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateTaskSources(dataTable);
      }
      return retValue;
    }
    ...
    public TaskSource Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TaskSource retValue = null;
    ...
    public void Update(TaskSource dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { TaskSource.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private TaskSource CreateTaskSource(DataTable dataTable)
    {
      TaskSource retValue = null;
    ...
    private TaskSources CreateTaskSources(DataTable dataTable)
    {
      TaskSources retValue = null;
  ...
  public ResultConverter<TaskSource, TaskSources> ResultConverter { get; set; }
