...
{
  /// <summary>Provides TaskStatus SQL data methods.</summary>
  public class TaskStatusSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public TaskStatusSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(TaskStatus.ColumnID, TaskStatus.PropertyID);
      dataDefinition.MapNames(TaskStatus.ColumnID, TaskStatus.PropertyID);
      ...
      ResultConverter = new ResultConverter<TaskStatus, TaskStatuses>();
    }
    #endregion
    ...
    public TaskStatus Add(TaskStatus dataObject, List<string> propertyNames = null)
    {
      TaskStatus retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateTaskStatus(dataTable);
      }
      return retValue;
    }
    ...
    public TaskStatuses Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TaskStatuses retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateTaskStatuses(dataTable);
      }
      return retValue;
    }
    ...
    public TaskStatus Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TaskStatus retValue = null;
    ...
    public void Update(TaskStatus dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { TaskStatus.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private TaskStatus CreateTaskStatus(DataTable dataTable)
    {
      TaskStatus retValue = null;
    ...
    private TaskStatuses CreateTaskStatuses(DataTable dataTable)
    {
      TaskStatuses retValue = null;
  ...
  public ResultConverter<TaskStatus, TaskStatuses> ResultConverter { get; set; }
