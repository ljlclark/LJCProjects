...
{
  /// <summary>Provides DocClass SQL data methods.</summary>
  public class DocClassSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocClassSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocClass.ColumnID, DocClass.PropertyID);
      dataDefinition.MapNames(DocClass.ColumnID, DocClass.PropertyID);
    ...
    public DocClass Add(DocClass dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocClass(dataTable);
      }
      return retValue;
    }
    ...
    public DocClasses Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocClasses(dataTable);
      }
      return retValue;
    }
    ...
    private DocClass CreateDocClass(DataTable dataTable)
    {
      DocClass retValue = null;
    ...
    private DocClasses CreateDocClasses(DataTable dataTable)
    {
      DocClasses retValue = null;
