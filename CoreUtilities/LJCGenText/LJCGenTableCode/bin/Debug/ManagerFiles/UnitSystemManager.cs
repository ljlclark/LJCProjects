...
{
  /// <summary>Provides UnitSystem SQL data methods.</summary>
  public class UnitSystemSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public UnitSystemSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(UnitSystem.ColumnID, UnitSystem.PropertyID);
      dataDefinition.MapNames(UnitSystem.ColumnID, UnitSystem.PropertyID);
      ...
      ResultConverter = new ResultConverter<UnitSystem, UnitSystems>();
    }
    #endregion
    ...
    public UnitSystem Add(UnitSystem dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateUnitSystem(dataTable);
      }
      return retValue;
    }
    ...
    public UnitSystems Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateUnitSystems(dataTable);
      }
      return retValue;
    }
    ...
    public UnitSystem Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UnitSystem retValue = null;
    ...
    public void Update(UnitSystem dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { UnitSystem.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private UnitSystem CreateUnitSystem(DataTable dataTable)
    {
      UnitSystem retValue = null;
    ...
    private UnitSystems CreateUnitSystems(DataTable dataTable)
    {
      UnitSystems retValue = null;
  ...
  public ResultConverter<UnitSystem, UnitSystems> ResultConverter { get; set; }
