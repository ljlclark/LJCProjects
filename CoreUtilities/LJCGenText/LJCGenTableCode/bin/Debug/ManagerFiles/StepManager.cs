...
{
  /// <summary>Provides Step SQL data methods.</summary>
  public class StepSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public StepSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Step.ColumnID, Step.PropertyID);
      dataDefinition.MapNames(Step.ColumnID, Step.PropertyID);
      ...
      ResultConverter = new ResultConverter<Step, Steps>();
    }
    #endregion
    ...
    public Step Add(Step dataObject, List<string> propertyNames = null)
    {
      Step retValue = null;
    ...
    public Steps Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateSteps(dataTable);
      }
      return retValue;
    }
    ...
    public Step Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Step retValue = null;
    ...
    public void Update(Step dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private Step CreateStep(DataTable dataTable)
    {
      Step retValue = null;
    ...
    private Steps CreateSteps(DataTable dataTable)
    {
      Steps retValue = null;
  ...
  public ResultConverter<Step, Steps> ResultConverter { get; set; }
