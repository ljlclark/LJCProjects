...
{
  /// <summary>Provides Address SQL data methods.</summary>
  public class AddressSQLManager
  {
    ...
    public AddressSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Address.ColumnID, Address.PropertyID);
      dataDefinition.MapNames(Address.ColumnID, Address.PropertyID);
      ...
      ResultConverter = new ResultConverter<Address, Addresses>();
    }
    #endregion
    ...
    public Address Add(Address dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateAddress(dataTable);
      }
      return retValue;
    }
    ...
    public Addresses Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Addresses retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateAddresses(dataTable);
      }
      return retValue;
    }
    ...
    public Address Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Address retValue = null;
    ...
    public void Update(Address dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { Address.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private Address CreateAddress(DataTable dataTable)
    {
      Address retValue = null;
    ...
    private Addresses CreateAddresses(DataTable dataTable)
    {
      Addresses retValue = null;
  ...
  public ResultConverter<Address, Addresses> ResultConverter { get; set; }
