...
{
  /// <summary>Provides SourceType SQL data methods.</summary>
  public class SourceTypeSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public SourceTypeSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(SourceType.ColumnID, SourceType.PropertyID);
      dataDefinition.MapNames(SourceType.ColumnID, SourceType.PropertyID);
      ...
      ResultConverter = new ResultConverter<SourceType, SourceTypes>();
    }
    #endregion
    ...
    public SourceType Add(SourceType dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateSourceType(dataTable);
      }
      return retValue;
    }
    ...
    public SourceTypes Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      SourceTypes retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateSourceTypes(dataTable);
      }
      return retValue;
    }
    ...
    public SourceType Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      SourceType retValue = null;
    ...
    public void Update(SourceType dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { SourceType.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private SourceType CreateSourceType(DataTable dataTable)
    {
      SourceType retValue = null;
    ...
    private SourceTypes CreateSourceTypes(DataTable dataTable)
    {
      SourceTypes retValue = null;
  ...
  public ResultConverter<SourceType, SourceTypes> ResultConverter { get; set; }
