...
{
  /// <summary>Provides DataType SQL data methods.</summary>
  public class DataTypeSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DataTypeSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DataType.ColumnID, DataType.PropertyID);
      dataDefinition.MapNames(DataType.ColumnID, DataType.PropertyID);
      ...
      ResultConverter = new ResultConverter<DataType, DataTypes>();
    }
    #endregion
    ...
    public DataType Add(DataType dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDataType(dataTable);
      }
      return retValue;
    }
    ...
    public DataTypes Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DataTypes retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDataTypes(dataTable);
      }
      return retValue;
    }
    ...
    public DataType Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DataType retValue = null;
    ...
    public void Update(DataType dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private DataType CreateDataType(DataTable dataTable)
    {
      DataType retValue = null;
    ...
    private DataTypes CreateDataTypes(DataTable dataTable)
    {
      DataTypes retValue = null;
  ...
  public ResultConverter<DataType, DataTypes> ResultConverter { get; set; }
