...
{
  /// <summary>Provides SourceStatus SQL data methods.</summary>
  public class SourceStatusSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public SourceStatusSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(SourceStatus.ColumnID, SourceStatus.PropertyID);
      dataDefinition.MapNames(SourceStatus.ColumnID, SourceStatus.PropertyID);
      ...
      ResultConverter = new ResultConverter<SourceStatus, SourceStatuses>();
    }
    #endregion
    ...
    public SourceStatus Add(SourceStatus dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateSourceStatus(dataTable);
      }
      return retValue;
    }
    ...
    public SourceStatuses Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      SourceStatuses retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateSourceStatuses(dataTable);
      }
      return retValue;
    }
    ...
    public SourceStatus Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      SourceStatus retValue = null;
    ...
    public void Update(SourceStatus dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { SourceStatus.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private SourceStatus CreateSourceStatus(DataTable dataTable)
    {
      SourceStatus retValue = null;
    ...
    private SourceStatuses CreateSourceStatuses(DataTable dataTable)
    {
      SourceStatuses retValue = null;
  ...
  public ResultConverter<SourceStatus, SourceStatuses> ResultConverter { get; set; }
