...
{
  /// <summary>Provides ViewColumn SQL data methods.</summary>
  public class ViewColumnSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewColumnSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewColumn.ColumnID, ViewColumn.PropertyID);
      dataDefinition.MapNames(ViewColumn.ColumnID, ViewColumn.PropertyID);
      ...
      ResultConverter = new ResultConverter<ViewColumn, ViewColumns>();
    }
    #endregion
    ...
    public ViewColumn Add(ViewColumn dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewColumn(dataTable);
      }
      return retValue;
    }
    ...
    public ViewColumns Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewColumns(dataTable);
      }
      return retValue;
    }
    ...
    public ViewColumn Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewColumn retValue = null;
    ...
    public void Update(ViewColumn dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ViewColumn.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ViewColumn CreateViewColumn(DataTable dataTable)
    {
      ViewColumn retValue = null;
    ...
    private ViewColumns CreateViewColumns(DataTable dataTable)
    {
      ViewColumns retValue = null;
  ...
  public ResultConverter<ViewColumn, ViewColumns> ResultConverter { get; set; }
