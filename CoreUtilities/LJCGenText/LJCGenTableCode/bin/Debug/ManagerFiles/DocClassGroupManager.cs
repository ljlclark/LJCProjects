...
{
  /// <summary>Provides DocClassGroup SQL data methods.</summary>
  public class DocClassGroupSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocClassGroupSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocClassGroup.ColumnID, DocClassGroup.PropertyID);
      dataDefinition.MapNames(DocClassGroup.ColumnID, DocClassGroup.PropertyID);
    ...
    public DocClassGroup Add(DocClassGroup dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocClassGroup(dataTable);
      }
      return retValue;
    }
    ...
    public DocClassGroups Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocClassGroups(dataTable);
      }
      return retValue;
    }
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DocClassGroup.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DocClassGroup CreateDocClassGroup(DataTable dataTable)
    {
      DocClassGroup retValue = null;
    ...
    private DocClassGroups CreateDocClassGroups(DataTable dataTable)
    {
      DocClassGroups retValue = null;
