...
{
  /// <summary>Provides Region SQL data methods.</summary>
  public class RegionSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public RegionSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Region.ColumnID, Region.PropertyID);
      dataDefinition.MapNames(Region.ColumnID, Region.PropertyID);
      ...
      ResultConverter = new ResultConverter<Region, Regions>();
    }
    #endregion
    ...
    public Region Add(Region dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateRegion(dataTable);
      }
      return retValue;
    }
    ...
    public Regions Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Regions retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateRegions(dataTable);
      }
      return retValue;
    }
    ...
    public Region Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Region retValue = null;
    ...
    public void Update(Region dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private Region CreateRegion(DataTable dataTable)
    {
      Region retValue = null;
    ...
    private Regions CreateRegions(DataTable dataTable)
    {
      Regions retValue = null;
  ...
  public ResultConverter<Region, Regions> ResultConverter { get; set; }
