...
{
  /// <summary>Provides UserAppProgram SQL data methods.</summary>
  public class UserAppProgramSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public UserAppProgramSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(UserAppProgram.ColumnID, UserAppProgram.PropertyID);
      dataDefinition.MapNames(UserAppProgram.ColumnID, UserAppProgram.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        UserAppProgram.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        UserAppProgram.ColumnName
      });

      ResultConverter = new ResultConverter<UserAppProgram, UserAppPrograms>();
    }
    #endregion
    ...
    public UserAppProgram Add(UserAppProgram dataObject, List<string> propertyNames = null)
    {
      UserAppProgram retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateUserAppProgram(dataTable);
      }
      return retValue;
    }
    ...
    public UserAppPrograms Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UserAppPrograms retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateUserAppPrograms(dataTable);
      }
      return retValue;
    }
    ...
    public UserAppProgram Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UserAppProgram retValue = null;
    ...
    public void Update(UserAppProgram dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { UserAppProgram.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private UserAppProgram CreateUserAppProgram(DataTable dataTable)
    {
      UserAppProgram retValue = null;
    ...
    private UserAppPrograms CreateUserAppPrograms(DataTable dataTable)
    {
      UserAppPrograms retValue = null;
  ...
  public ResultConverter<UserAppProgram, UserAppPrograms> ResultConverter { get; set; }
