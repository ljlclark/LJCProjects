...
{
  /// <summary>Provides Fixture SQL data methods.</summary>
  public class FixtureSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public FixtureSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Fixture.ColumnID, Fixture.PropertyID);
      dataDefinition.MapNames(Fixture.ColumnID, Fixture.PropertyID);
      ...
      ResultConverter = new ResultConverter<Fixture, Fixtures>();
    }
    #endregion
    ...
    public Fixture Add(Fixture dataObject, List<string> propertyNames = null)
    {
      Fixture retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateFixture(dataTable);
      }
      return retValue;
    }
    ...
    public Fixtures Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Fixtures retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateFixtures(dataTable);
      }
      return retValue;
    }
    ...
    public Fixture Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Fixture retValue = null;
    ...
    public void Update(Fixture dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { Fixture.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private Fixture CreateFixture(DataTable dataTable)
    {
      Fixture retValue = null;
    ...
    private Fixtures CreateFixtures(DataTable dataTable)
    {
      Fixtures retValue = null;
  ...
  public ResultConverter<Fixture, Fixtures> ResultConverter { get; set; }
