...
{
  /// <summary>Provides ControlTab SQL data methods.</summary>
  public class ControlTabSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ControlTabSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ControlTab.ColumnID, ControlTab.PropertyID);
      dataDefinition.MapNames(ControlTab.ColumnID, ControlTab.PropertyID);
    ...
    public ControlTab Add(ControlTab dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlTab(dataTable);
      }
      return retValue;
    }
    ...
    public ControlTabs Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ControlTabs retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateControlTabs(dataTable);
      }
      return retValue;
    }
    ...
    public ControlTab Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ControlTab retValue = null;
    ...
    private ControlTab CreateControlTab(DataTable dataTable)
    {
      ControlTab retValue = null;
    ...
    private ControlTabs CreateControlTabs(DataTable dataTable)
    {
      ControlTabs retValue = null;
