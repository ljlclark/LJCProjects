...
{
  /// <summary>Provides City SQL data methods.</summary>
  public class CitySQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public CitySQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(City.ColumnID, City.PropertyID);
      dataDefinition.MapNames(City.ColumnID, City.PropertyID);
      ...
      ResultConverter = new ResultConverter<City, Cities>();
    }
    #endregion
    ...
    public City Add(City dataObject, List<string> propertyNames = null)
    {
      City retValue = null;
    ...
    public Cities Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Cities retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateCities(dataTable);
      }
      return retValue;
    }
    ...
    public City Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      City retValue = null;
    ...
    public void Update(City dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private City CreateCity(DataTable dataTable)
    {
      City retValue = null;
    ...
    private Cities CreateCities(DataTable dataTable)
    {
      Cities retValue = null;
  ...
  public ResultConverter<City, Cities> ResultConverter { get; set; }
