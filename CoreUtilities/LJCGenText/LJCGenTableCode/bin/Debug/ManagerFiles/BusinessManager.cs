...
{
  /// <summary>Provides Business SQL data methods.</summary>
  public class BusinessSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public BusinessSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Business.ColumnID, Business.PropertyID);
      dataDefinition.MapNames(Business.ColumnID, Business.PropertyID);
      ...
      ResultConverter = new ResultConverter<Business, Businesses>();
    }
    #endregion
    ...
    public Business Add(Business dataObject, List<string> propertyNames = null)
    {
      Business retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateBusiness(dataTable);
      }
      return retValue;
    }
    ...
    public Businesses Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Businesses retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateBusinesses(dataTable);
      }
      return retValue;
    }
    ...
    public Business Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Business retValue = null;
    ...
    public void Update(Business dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { Business.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private Business CreateBusiness(DataTable dataTable)
    {
      Business retValue = null;
    ...
    private Businesses CreateBusinesses(DataTable dataTable)
    {
      Businesses retValue = null;
  ...
  public ResultConverter<Business, Businesses> ResultConverter { get; set; }
