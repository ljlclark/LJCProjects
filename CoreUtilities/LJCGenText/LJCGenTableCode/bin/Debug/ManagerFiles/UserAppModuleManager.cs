...
{
  /// <summary>Provides UserAppModule SQL data methods.</summary>
  public class UserAppModuleSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public UserAppModuleSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(UserAppModule.ColumnID, UserAppModule.PropertyID);
      dataDefinition.MapNames(UserAppModule.ColumnID, UserAppModule.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        UserAppModule.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        UserAppModule.ColumnName
      });

      ResultConverter = new ResultConverter<UserAppModule, UserAppModules>();
    }
    #endregion
    ...
    public UserAppModule Add(UserAppModule dataObject, List<string> propertyNames = null)
    {
      UserAppModule retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateUserAppModule(dataTable);
      }
      return retValue;
    }
    ...
    public UserAppModules Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UserAppModules retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateUserAppModules(dataTable);
      }
      return retValue;
    }
    ...
    public UserAppModule Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      UserAppModule retValue = null;
    ...
    public void Update(UserAppModule dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { UserAppModule.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private UserAppModule CreateUserAppModule(DataTable dataTable)
    {
      UserAppModule retValue = null;
    ...
    private UserAppModules CreateUserAppModules(DataTable dataTable)
    {
      UserAppModules retValue = null;
  ...
  public ResultConverter<UserAppModule, UserAppModules> ResultConverter { get; set; }
