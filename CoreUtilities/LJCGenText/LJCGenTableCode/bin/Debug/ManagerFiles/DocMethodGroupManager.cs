...
{
  /// <summary>Provides DocMethodGroup SQL data methods.</summary>
  public class DocMethodGroupSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocMethodGroupSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocMethodGroup.ColumnID, DocMethodGroup.PropertyID);
      dataDefinition.MapNames(DocMethodGroup.ColumnID, DocMethodGroup.PropertyID);
    ...
    public DocMethodGroup Add(DocMethodGroup dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocMethodGroup(dataTable);
      }
      return retValue;
    }
    ...
    public DocMethodGroups Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateDocMethodGroups(dataTable);
      }
      return retValue;
    }
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { DocMethodGroup.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private DocMethodGroup CreateDocMethodGroup(DataTable dataTable)
    {
      DocMethodGroup retValue = null;
    ...
    private DocMethodGroups CreateDocMethodGroups(DataTable dataTable)
    {
      DocMethodGroups retValue = null;
