...
{
  /// <summary>Provides Facility SQL data methods.</summary>
  public class FacilitySQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public FacilitySQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Facility.ColumnID, Facility.PropertyID);
      dataDefinition.MapNames(Facility.ColumnID, Facility.PropertyID);
      ...
      ResultConverter = new ResultConverter<Facility, Facilities>();
    }
    #endregion
    ...
    public Facility Add(Facility dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateFacility(dataTable);
      }
      return retValue;
    }
    ...
    public Facilities Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Facilities retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateFacilities(dataTable);
      }
      return retValue;
    }
    ...
    public Facility Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Facility retValue = null;
    ...
    public void Update(Facility dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { Facility.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private Facility CreateFacility(DataTable dataTable)
    {
      Facility retValue = null;
    ...
    private Facilities CreateFacilities(DataTable dataTable)
    {
      Facilities retValue = null;
  ...
  public ResultConverter<Facility, Facilities> ResultConverter { get; set; }
