...
{
  /// <summary>Provides ViewJoinOn SQL data methods.</summary>
  public class ViewJoinOnSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewJoinOnSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewJoinOn.ColumnID, ViewJoinOn.PropertyID);
      dataDefinition.MapNames(ViewJoinOn.ColumnID, ViewJoinOn.PropertyID);
      ...
      {
        ViewJoinOn.ColumnName
      });

      ResultConverter = new ResultConverter<ViewJoinOn, ViewJoinOns>();
    }
    #endregion
    ...
    public ViewJoinOn Add(ViewJoinOn dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewJoinOn(dataTable);
      }
      return retValue;
    }
    ...
    public ViewJoinOns Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewJoinOns(dataTable);
      }
      return retValue;
    }
    ...
    public ViewJoinOn Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewJoinOn retValue = null;
    ...
    public void Update(ViewJoinOn dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ViewJoinOn.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ViewJoinOn CreateViewJoinOn(DataTable dataTable)
    {
      ViewJoinOn retValue = null;
    ...
    private ViewJoinOns CreateViewJoinOns(DataTable dataTable)
    {
      ViewJoinOns retValue = null;
  ...
  public ResultConverter<ViewJoinOn, ViewJoinOns> ResultConverter { get; set; }
