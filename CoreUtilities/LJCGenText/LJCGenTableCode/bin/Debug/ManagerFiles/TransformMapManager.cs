...
{
  /// <summary>Provides TransformMap SQL data methods.</summary>
  public class TransformMapSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public TransformMapSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(TransformMap.ColumnID, TransformMap.PropertyID);
      dataDefinition.MapNames(TransformMap.ColumnID, TransformMap.PropertyID);

      // Create the list of DB Assigned and Lookup column names.
      SQLManager.DbAssignedColumns = new List<string>()
      {
        TransformMap.ColumnID
      };
      SQLManager.SetLookupColumns(new string[]
      {
        TransformMap.ColumnName
      });

      ResultConverter = new ResultConverter<TransformMap, TransformMaps>();
    }
    #endregion
    ...
    public TransformMap Add(TransformMap dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateTransformMap(dataTable);
      }
      return retValue;
    }
    ...
    public TransformMaps Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TransformMaps retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateTransformMaps(dataTable);
      }
      return retValue;
    }
    ...
    public TransformMap Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      TransformMap retValue = null;
    ...
    public void Update(TransformMap dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { TransformMap.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private TransformMap CreateTransformMap(DataTable dataTable)
    {
      TransformMap retValue = null;
    ...
    private TransformMaps CreateTransformMaps(DataTable dataTable)
    {
      TransformMaps retValue = null;
  ...
  public ResultConverter<TransformMap, TransformMaps> ResultConverter { get; set; }
