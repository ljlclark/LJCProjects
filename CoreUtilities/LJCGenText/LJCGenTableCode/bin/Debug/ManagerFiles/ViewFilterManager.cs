...
{
  /// <summary>Provides ViewFilter SQL data methods.</summary>
  public class ViewFilterSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ViewFilterSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ViewFilter.ColumnID, ViewFilter.PropertyID);
      dataDefinition.MapNames(ViewFilter.ColumnID, ViewFilter.PropertyID);
      ...
      ResultConverter = new ResultConverter<ViewFilter, ViewFilters>();
    }
    #endregion
    ...
    public ViewFilter Add(ViewFilter dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewFilter(dataTable);
      }
      return retValue;
    }
    ...
    public ViewFilters Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateViewFilters(dataTable);
      }
      return retValue;
    }
    ...
    public ViewFilter Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ViewFilter retValue = null;
    ...
    public void Update(ViewFilter dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private ViewFilter CreateViewFilter(DataTable dataTable)
    {
      ViewFilter retValue = null;
    ...
    private ViewFilters CreateViewFilters(DataTable dataTable)
    {
      ViewFilters retValue = null;
  ...
  public ResultConverter<ViewFilter, ViewFilters> ResultConverter { get; set; }
