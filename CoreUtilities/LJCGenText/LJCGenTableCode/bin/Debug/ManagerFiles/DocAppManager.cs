...
{
  /// <summary>Provides DocApp SQL data methods.</summary>
  public class DocAppSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public DocAppSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(DocApp.ColumnID, DocApp.PropertyID);
      dataDefinition.MapNames(DocApp.ColumnID, DocApp.PropertyID);
      ...
      ResultConverter = new ResultConverter<DocApp, DocApps>();
    }
    #endregion
    ...
    public DocApp Add(DocApp dataObject, List<string> propertyNames = null)
    {
      DocApp retValue = null;
      ...
      if (dataTable != null)
      {
        retValue = CreateDocApp(dataTable);
      }
      return retValue;
    }
    ...
    public DocApps Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocApps retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateDocApps(dataTable);
      }
      return retValue;
    }
    ...
    public DocApp Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      DocApp retValue = null;
    ...
    public void Update(DocApp dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private DocApp CreateDocApp(DataTable dataTable)
    {
      DocApp retValue = null;
    ...
    private DocApps CreateDocApps(DataTable dataTable)
    {
      DocApps retValue = null;
  ...
  public ResultConverter<DocApp, DocApps> ResultConverter { get; set; }
