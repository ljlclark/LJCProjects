...
{
  /// <summary>Provides CodeType SQL data methods.</summary>
  public class CodeTypeSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public CodeTypeSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(CodeType.ColumnID, CodeType.PropertyID);
      dataDefinition.MapNames(CodeType.ColumnID, CodeType.PropertyID);
      ...
      ResultConverter = new ResultConverter<CodeType, CodeTypes>();
    }
    #endregion
    ...
    public CodeType Add(CodeType dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateCodeType(dataTable);
      }
      return retValue;
    }
    ...
    public CodeTypes Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      CodeTypes retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateCodeTypes(dataTable);
      }
      return retValue;
    }
    ...
    public CodeType Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      CodeType retValue = null;
    ...
    public void Update(CodeType dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { CodeType.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private CodeType CreateCodeType(DataTable dataTable)
    {
      CodeType retValue = null;
    ...
    private CodeTypes CreateCodeTypes(DataTable dataTable)
    {
      CodeTypes retValue = null;
  ...
  public ResultConverter<CodeType, CodeTypes> ResultConverter { get; set; }
