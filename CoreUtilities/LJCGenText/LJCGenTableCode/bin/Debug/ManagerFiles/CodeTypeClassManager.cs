...
{
  /// <summary>Provides CodeTypeClass SQL data methods.</summary>
  public class CodeTypeClassSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public CodeTypeClassSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(CodeTypeClass.ColumnID, CodeTypeClass.PropertyID);
      dataDefinition.MapNames(CodeTypeClass.ColumnID, CodeTypeClass.PropertyID);
      ...
      {
        CodeTypeClass.ColumnName
      });

      ResultConverter = new ResultConverter<CodeTypeClass, CodeTypeClasses>();
    }
    #endregion
    ...
    public CodeTypeClass Add(CodeTypeClass dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateCodeTypeClass(dataTable);
      }
      return retValue;
    }
    ...
    public CodeTypeClasses Load(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      CodeTypeClasses retValue = null;

      DataTable dataTable = LoadDataTable(keyColumns, propertyNames
        , filters, joins);
      if (dataTable != null)
      {
        retValue = CreateCodeTypeClasses(dataTable);
      }
      return retValue;
    }
    ...
    public CodeTypeClass Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      CodeTypeClass retValue = null;
    ...
    public void Update(CodeTypeClass dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { CodeTypeClass.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private CodeTypeClass CreateCodeTypeClass(DataTable dataTable)
    {
      CodeTypeClass retValue = null;
    ...
    private CodeTypeClasses CreateCodeTypeClasses(DataTable dataTable)
    {
      CodeTypeClasses retValue = null;
  ...
  public ResultConverter<CodeTypeClass, CodeTypeClasses> ResultConverter { get; set; }
