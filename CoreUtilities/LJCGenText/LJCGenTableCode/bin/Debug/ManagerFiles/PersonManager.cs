...
{
  /// <summary>Provides Person SQL data methods.</summary>
  public class PersonSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public PersonSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(Person.ColumnID, Person.PropertyID);
      dataDefinition.MapNames(Person.ColumnID, Person.PropertyID);
    ...
    public Persons Load(DbColumns keyColumns
    ...
    public Person Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      Person retValue = null;
    ...
    public void Update(Person dataObject, DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null)
    {
    ...
    private Person CreatePerson(DataTable dataTable)
    {
      Person retValue = null;
    ...
    private Persons CreatePersons(DataTable dataTable)
    {
      Persons retValue = null;
  ...
  public ResultConverter<Person, Persons> ResultConverter { get; set; }
