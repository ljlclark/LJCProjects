...
{
  /// <summary>Provides ControlRow SQL data methods.</summary>
  public class ControlRowSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ControlRowSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ControlRow.ColumnID, ControlRow.PropertyID);
      dataDefinition.MapNames(ControlRow.ColumnID, ControlRow.PropertyID);
    ...
    public ControlRow Add(ControlRow dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlRow(dataTable);
      }
      return retValue;
    }
    ...
    public ControlRows Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlRows(dataTable);
      }
      return retValue;
    }
    ...
    public ControlRow Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ControlRow retValue = null;
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ControlRow.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ControlRow CreateControlRow(DataTable dataTable)
    {
      ControlRow retValue = null;
    ...
    private ControlRows CreateControlRows(DataTable dataTable)
    {
      ControlRows retValue = null;
