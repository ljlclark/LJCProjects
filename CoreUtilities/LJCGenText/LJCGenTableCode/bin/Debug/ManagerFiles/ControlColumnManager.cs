...
{
  /// <summary>Provides ControlColumn SQL data methods.</summary>
  public class ControlColumnSQLManager
  {
    #region Constructors

    // Initializes an object instance.
    /// <include path='items/DbManagerC/*' file='../../LJCDocLib/Common/DbManager.xml'/>
    public ControlColumnSQLManager(string dataConfigName, string tableName
    ...
    , string connectionString = null, string providerName = null)
  {
    ...
    if (SQLManager.DataDefinition != null)
    {
      ...
      baseDataDefinition.MapNames(ControlColumn.ColumnID, ControlColumn.PropertyID);
      dataDefinition.MapNames(ControlColumn.ColumnID, ControlColumn.PropertyID);
    ...
    public ControlColumn Add(ControlColumn dataObject, List<string> propertyNames = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlColumn(dataTable);
      }
      return retValue;
    }
    ...
    public ControlColumns Load(DbColumns keyColumns
      ...
      , DbJoins joins = null)
    {
      ...
      if (dataTable != null)
      {
        retValue = CreateControlColumns(dataTable);
      }
      return retValue;
    }
    ...
    public ControlColumn Retrieve(DbColumns keyColumns
      , List<string> propertyNames = null, DbFilters filters = null
      , DbJoins joins = null)
    {
      ControlColumn retValue = null;
    ...
    public DbColumns GetNameKey(string name)
    {
      ...
      var retValue = new DbColumns()
      {
        { ControlColumn.ColumnName, (object)name }
      };
      return retValue;
    }
    #endregion
    ...
    private ControlColumn CreateControlColumn(DataTable dataTable)
    {
      ControlColumn retValue = null;
    ...
    private ControlColumns CreateControlColumns(DataTable dataTable)
    {
      ControlColumns retValue = null;
