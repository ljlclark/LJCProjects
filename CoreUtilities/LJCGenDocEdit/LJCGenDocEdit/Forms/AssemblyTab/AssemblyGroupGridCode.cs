...
namespace LJCGenDocEdit
{
  ...
  internal class AssemblyGroupGridCode
  {
    ...
    internal AssemblyGroupGridCode(LJCGenDocList parentList)
    {
      ...
      ArgError = new ArgError("LJCGenDocEdit.AssemblyGroupGridCode");
    ...
    internal void DataRetrieve()
    {
      ...
      DbResult result = manager.LoadResult(propertyNames: propertyNames);
    ...
    internal void SetupGrid()
    {
      ...
      if (mGridColumns != null)
      {
        ...
        columns.LJCRemove(DocAssemblyGroup.ColumnID);
