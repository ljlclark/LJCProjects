...
namespace LJCGenDocEdit
{
  internal partial class MethodHeadingSelect : Form
  {
    ...
    private void RestoreControlValues()
    {
      ...
      if (File.Exists(mControlValuesFileName))
      {
        ...
        if (ControlValues != null)
        {
          ...
          MethodHeadingGrid.LJCRestoreColumnValues(ControlValues);
        }
      }
    }
    ...
    private void SaveControlValues()
    {
      ...
      MethodHeadingGrid.LJCSaveColumnValues(controlValues);
    ...
    {
      MethodHeadingGridCode = new MethodHeadingGridCode(this);
    }
    ...
    {
      bool enableNew = true;
      bool enableEdit = MethodHeadingGrid.CurrentRow != null;
