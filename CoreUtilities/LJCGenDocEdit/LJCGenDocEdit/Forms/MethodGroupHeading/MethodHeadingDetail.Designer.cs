...
{
  partial class MethodHeadingDetail
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      this.Name = "MethodHeadingDetail";
      this.ShowInTaskbar = false;
      this.Text = "Method Group Heading Detail";
      this.Load += new System.EventHandler(this.MethodHeadingDetail_Load);
