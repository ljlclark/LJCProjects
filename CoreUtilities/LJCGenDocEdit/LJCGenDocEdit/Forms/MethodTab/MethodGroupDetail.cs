...
namespace LJCGenDocEdit
{
  ...
  internal partial class MethodGroupDetail : Form
  {
    #region Constructors

    // Initializes an object instance.
    internal MethodGroupDetail()
    {
      InitializeComponent();
    ...
    private bool DataSave()
    {
      ...
      var manager = LJCManagers.DocMethodGroupManager;
    ...
    private void GroupButton_Click(object sender, EventArgs e)
    {
      ...
      {
        LJCIsSelect = true,
        LJClassID = LJCClassID
      };
      list.LJCChange += List_LJCChange;
      if (DialogResult.OK == list.ShowDialog())
      {
        if (1 == list.MethodHeadingGrid.SelectedRows.Count)
        {
          SelectedChange(list);
        }
      }
    ...
    private void SelectedChange(MethodHeadingSelect list)
    {
    ...
    // Gets or sets the parent Class ID value.
