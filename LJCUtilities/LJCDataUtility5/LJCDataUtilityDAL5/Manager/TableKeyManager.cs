...
namespace LJCDataUtilityDAL5
{
  ...
  public class TableKeyManager
  {
    ...
    {
      //Manager = null;
      ResultConverter = new LJCResultConverter<TableKey, TableKeys>();
      _TableName = "";
    }
    ...
    public TableKeyManager(LJCDbServiceRef dbServiceRef, string dataConfigName
      ...
      , string? constraintName = null)
    {
      ...
      if (Manager.TableName != null)
      {
        ...
        if (dbResult != null)
        {
          retTableKeys = ResultConverter.CreateCollection(dbResult);
        }
      }
      return retTableKeys;
    }
      ...
      , string keyType = "PRIMARY KEY", string? uniqueConstraintName = null)
    {
      ...
      if (LJC.HasText(uniqueConstraintName))
      {
    ...
    public LJCDataManager Manager { get; set; } = null!;

    // Gets or sets the ResultConverter reference.
    /// <include file='Doc/TableKeyManager.xml'
    ///  path='members/ResultConverter/*'/>
    public LJCResultConverter<TableKey, TableKeys> ResultConverter { get; set; }
