...
namespace LJCGenTextLib5
{
  ...
  public class DefaultValues
  {
    ...
    public string ComparerName { get; set; } = null!;

    // Gets or sets the default CompareToName value.
    /// <include file='Doc/ProjectGenTextLib.xml'
    ///  path='items/CompareToName/*'/>
    public string CompareToName { get; set; } = null!;
    ...
    public string FullAppName { get; set; } = null!;
    ...
    public string ToStringName { get; set; } = null!;
  }
}
