  ...
  public class Directive
  {
      ...
      , string commentChars)
    {
      ...
      if (directive != null
        ...
        && LJC.IsEqual(IfBegin, directive.ID))
      {
        retValue = true;
      }
      return retValue;
      ...
      , string commentChars)
    {
      ...
      if (directive != null
        ...
        && LJC.IsEqual(IfElse, directive.ID))
      {
        retValue = true;
      }
      return retValue;
      ...
      , string commentChars)
    {
      ...
      if (directive != null
        ...
        && LJC.IsEqual(IfEnd, directive.ID))
      {
        retValue = true;
      }
      return retValue;
      ...
      , string commentChars)
    {
      ...
      if (directive != null
        ...
        && LJC.IsEqual(SectionBegin, directive.ID))
      {
        retValue = true;
      }
      return retValue;
      ...
      , string commentChars)
    {
      ...
      if (directive != null
        ...
        && LJC.IsEqual(SectionEnd, directive.ID))
      {
        retValue = true;
      }
      return retValue;
    ...
    internal static bool IsValue(Directive directive)
    {
      ...
      if (directive != null
        ...
        && LJC.IsEqual(ValueDirective, directive.ID))
      {
        retValue = true;
      }
      return retValue;
    ...
    public bool IsSectionBegin()
    {
      ...
      if (LJC.IsEqual(SectionBegin, ID))
      {
        retValue = true;
      }
      return retValue;
