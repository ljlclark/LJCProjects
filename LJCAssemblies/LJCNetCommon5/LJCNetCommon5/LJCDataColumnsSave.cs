...
namespace LJCNetCommon5
{
  ...
  public class LJCDataColumnsX : List<LJCDataColumnX>
  {
    ...
    public static LJCDataColumnsX? LJCGetColumns(object dataObject
    ...
    /// <parentGroup>static</parentGroup>
    public static LJCDataColumnsX? LJCObjectDataColumns(object dataObject
      , LJCDataColumnsX? dataColumns = null)
    {
      LJCDataColumnsX retColumns = null;
      ...
      if (propertyNames != null)
      {
        ...
        foreach (string propertyName in propertyNames)
        {
          ...
          LJCDataColumnX dataColumn = null;
          if (dataColumns != null)
          {
            dataColumn = dataColumns.LJCSearchPropertyName(propertyName);
          }

          var addDataColumn = new LJCDataColumnX()
          {
    ...
    /// <parentGroup>static</parentGroup>
    public static implicit operator LJCDataValues(LJCDataColumnsX dataColumns)
    {
      ...
      {
        retValue = [];
        foreach (LJCDataColumnX dataColumn in dataColumns)
        {
    ...
    // Sets the Map values.
    private static void SetMapValues(LJCDataColumnX? dataColumn, string? propertyName = null
    ...
    /// <parentGroup>constructors</parentGroup>
    public LJCDataColumnsX(LJCDataColumnsX? items)
    {
      if (LJC.HasListItems(items))
      {
        foreach (var item in items)
        {
          Add(new LJCDataColumnX(item));
        }
      }
    }
    #endregion
    ...
    public void LJCSetColumnCaptions(LJCDataColumnsX dataColumns)
    {
      LJCDataColumnX searchColumn;
    ...
    /// <parentGroup>collection</parentGroup>
    public new void Add(LJCDataColumnX dataColumn)
    {
    ...
    /// <parentGroup>collection</parentGroup>
    public LJCDataColumnX Add(string columnName, object value
    ...
    /// <parentGroup>collection</parentGroup>
    public LJCDataColumnsX Clone()
    {
      var retValue = new LJCDataColumnsX();
      foreach (LJCDataColumnX dataColumn in this)
      {
    ...
    /// <parentGroup>collection</parentGroup>
    public LJCDataColumnX LJCAddPropertyAs(string propertyName, string? caption = null
      , string? renameAs = null, string dataTypeName = "String")
    {
      var retValue = new LJCDataColumnX()
      {
    ...
    /// <parentGroup>collection</parentGroup>
    public LJCDataColumnX? LJCGetColumn(string propertyName)
    {
      LJCDataColumnX retValue = null;
    ...
    /// <parentGroup>collection</parentGroup>
    public LJCDataColumnsX? LJCGetColumns(List<string> propertyNames)
    {
      LJCDataColumnX searchColumn;
      LJCDataColumnsX retValue = null;
      ...
      if (LJC.HasListItems(propertyNames))
      {
        ...
        foreach (string propertyName in propertyNames)
        {
          ...
          if (searchColumn != null)
          {
            retValue.Add(new LJCDataColumnX(searchColumn));
          }
        }
      }
      return retValue;
    ...
    /// <parentGroup>collection</parentGroup>
    public void LJCSetData(LJCDataColumnX dataColumn)
    {
      if (LJC.HasListItems(this))
      {
    ...
    /// <parentGroup>item</parentGroup>
    public LJCDataColumnsX LJCGetChanged()
    {
      List<LJCDataColumnX> columns;
      var retValue = new LJCDataColumnsX();

      columns = FindAll(x => x.IsChanged);
      foreach (LJCDataColumnX dataColumn in columns)
      {
        retValue.Add(dataColumn.Clone()!);
      }
      return retValue;
    ...
    public LJCDataColumnX? LJCSearchColumnName(string? name)
    {
      ...
      if (LJC.HasText(name))
      {
        ...
        var searchDbColumn = new LJCDataColumnX()
        {
          ColumnName = name
        };
    ...
    /// <parentGroup>search</parentGroup>
    public LJCDataColumnX? LJCSearchPropertyName(string? propertyName)
    {
      LJCDataColumnX retValue = null;
    ...
    /// <parentGroup>search</parentGroup>
    public LJCDataColumnX? LJCSearchRenameAs(string? renameAs)
    {
      LJCDataColumnX retValue = null;
    ...
    public LJCDataColumnX? this[string propertyName]
    {
