...
namespace LJCNetCommon5
{
  ...
  public class LJCDataColumnX : IComparable<LJCDataColumn>
  {
    #region Constructors
    ...
    /// <parentGroup>constructor</parentGroup>
    public LJCDataColumnX(LJCDataColumnX item)
    {
    ...
    /// <parentGroup>constructor</parentGroup>
    public LJCDataColumnX(string columnName, string? value = null, string dataTypeName = "String"
    ...
    public static implicit operator LJCDataValue(LJCDataColumnX dbColumn)
    {
