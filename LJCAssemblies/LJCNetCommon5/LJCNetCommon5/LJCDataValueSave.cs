...
namespace LJCNetCommon5
{
  ...
  public class LJCDataValueX : IComparable<LJCDataValueX>
  {
    ...
    /// <parentGroup>constructors</parentGroup>
    public LJCDataValueX(LJCDataValue item)
    {
    ...
    /// <parentGroup>constructors</parentGroup>
    public LJCDataValueX(string propertyName, object? value = null
    ...
    /// <parentGroup>data</parentGroup>
    public int CompareTo(LJCDataValueX? other)
    {
      int retValue;
