...
namespace LJCDataAccessConfig
{
  ...
  public class LJCDataConfig
  {
    ...
    {
      if (LJCNetString.HasValue(connectionType))
      {
    ...
    public string? ConnectionStringFromTemplate(string? templateText)
    {
      ...
      if (LJCNetString.HasValue(templateText))
      {
    ...
    private string? ReplacementValue(string marker)
    {
      ...
      {
        case "dbserver":
          if (LJCNetString.HasValue(DbServer))
          {
            retValue = DbServer;
          }
          break;
        ...
        case "database":
          if (LJCNetString.HasValue(Database))
          {
            retValue = Database;
          }
          break;
        ...
        case "uid":
          if (LJCNetString.HasValue(UserID))
          {
            retValue = UserID;
          }
          break;
