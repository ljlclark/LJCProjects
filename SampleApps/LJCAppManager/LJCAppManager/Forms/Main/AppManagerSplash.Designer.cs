...
{
	partial class AppManagerSplash
	{
		/// <summary>
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AppManagerSplash));
			...
			this.label5.Text = "Copyright (c) Lester J. Clark 2017- 2019";
			// 
			// label4
			// 
			...
			this.label3.Text = "An Application Workspace";
			// 
			// label2
			// 
