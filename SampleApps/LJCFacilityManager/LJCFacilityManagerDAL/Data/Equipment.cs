...
namespace LJCFacilityManagerDAL
{
	...
	public class EquipmentItems : List<Equipment> { }

	/// <summary>Represents an equipment data record.</summary>
	[DataContract]
	public class Equipment
	{
		...
		{
			Equipment retValue = MemberwiseClone() as Equipment;
			return retValue;
		}
		...
		public String UnitDescription
		{
			...
			set
			{
				mUnitDescription = ChangedNames.Add(ColumnUnitDescription, mUnitDescription, value);
			}
		}
