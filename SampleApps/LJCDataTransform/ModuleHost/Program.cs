...
namespace ModuleHost
{
	...
	static class Program
	{
		...
		private static string GetDebugModuleName()
		{
			...
			//retValue = "LJCTransformManager.ProcessGroupModule";
			//retValue = "LJCTransformManager.ProcessStepModule";
			retValue = "LJCTransformManager.TaskSourceModule";
			//retValue = "LJCTransformManager.SourceLayoutModule";
			//retValue = "LJCTransformManager.LayoutColumnModule";
			return retValue;
		}
		...
		static void Main(string[] args)
		{
			...
			{
				args = new string[2];
				args[0] = "LJCTransformManager.exe";
			}
			if (1 == args.Length)
			{
				string temp = args[0];
