...
{
	/// <summary>Represents a collection of DataSource objects.</summary>
	public class DataSources : List<DataSource>
	{
		...
		public DataSource Add(int id, string name)
		{
		...
		public DataSource LJCSearchName(string name)
		{
			DataSource retValue = null;

			LJCSortDefault();
			DataSource searchItem = new DataSource()
			{
				Name = name
			};
