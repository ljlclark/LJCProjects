...
{
	/// <summary>Represents a collection of TaskStatus objects.</summary>
	public class TaskStatuses : List<TaskStatus>
	{
		#region Constructors
		...
		public TaskStatus Add(short id, string name)
		{
		...
		public TaskStatus LJCSearchName(string name)
		{
			TaskStatus retValue = null;

			LJCSortDefault();
			TaskStatus searchItem = new TaskStatus()
			{
				Name = name
			};
