...
{
	/// <summary>Represents a collection of Step objects.</summary>
	public class Steps : List<Step>
	{
		...
		public Step Add(int id, string name)
		{
			Step retValue = null;
		...
		public Step LJCSearchName(string name)
		{
			Step retValue = null;

			LJCSortDefault();
			Step searchItem = new Step()
			{
				Name = name
			};
