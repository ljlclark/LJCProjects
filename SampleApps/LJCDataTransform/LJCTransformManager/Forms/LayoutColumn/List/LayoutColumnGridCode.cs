...
{
	// Code for the LayoutColumn Grid control.
	internal class LayoutColumnGridCode
	{
		#region Constructors

		// Initializes an object instance.
		internal LayoutColumnGridCode(LayoutColumnList parent)
		{
			mParent = parent;
		...
		internal void DataRetrieveLayoutColumn()
		{
			...
			mParent.DoChange(LayoutColumnList.Change.LayoutColumn);
		}
		...
		private void LayoutColumnDetail_LJCChange(object sender, EventArgs e)
		{
			...
			else
			{
				...
				mLayoutColumnGrid.LJCSetCurrentRow(row, true);
				mParent.TimedChange(LayoutColumnList.Change.LayoutColumn);
			}
		}
