  ...
  public class Program
  {
    ...
    private static void Main(string[] args)
    {
      ...
      if (args.Length < 0 || args.Length > 2)
      {
        ...
        Console.WriteLine(@"outputPath: defaults to '..\..\..\..\..\Doc'");
        Console.WriteLine("groups.xml: default to DocGenGroups.xml");
    ...
    private static void CreateDocXml()
    {
      ...
      string xml = NetCommon.XmlSerializeToString(doc.GetType()
        , doc, null);
    }
